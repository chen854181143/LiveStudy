package com.chenyang.livestudy.network;

import android.text.TextUtils;

import com.chenyang.livestudy.app.YuYouBangApp;
import com.chenyang.livestudy.utils.ContextUtil;
import com.chenyang.livestudy.utils.CookieUtil;
import com.chenyang.livestudy.utils.LogUtils;
import com.chenyang.livestudy.utils.NetUtil;
import com.chenyang.livestudy.utils.UserAgentUtils;
    ...
    public static void initOkHttpClient() {
        if (mOkHttpClient == null) {
            synchronized (HttpClient.class) {
                ...
                // 指定缓存路径,缓存大小100Mb
                Cache cache = new Cache(new File(YuYouBangApp.getContext().getCacheDir(), "YuYouBang"),
                        1024 * 1024 * 100);
